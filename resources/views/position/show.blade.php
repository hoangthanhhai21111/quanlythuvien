...
@section('content')
    ...
    <main id="main" class="main">
        ...
        <div class="page-section">
            <form method="post" action="{{ route('position.UpdatePositionRole', $item->id) }}">
                @csrf
                @method('PUT')
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="tf1">Tên nhóm</label> <input name="name" value="{{ $item->name }}"
                                type="text" class="form-control" id="" placeholder="Nhập tên nhóm"> <small
                                    ...
                                    <div class="list-group list-group-flush list-group-bordered col-lg-4">
                                        ...
                                        @foreach ($roles as $role)
                                            <div class="list-group-item d-flex justify-content-between align-items-center">
                                                <span style="color: rgb(103, 40, 40) ;">{{ __($role['role_name']) }}</span>
                                                <!-- .switcher-control -->
